...
//question
const question = Array.from(document.getElementsByClassName("questionItem"))
const answer = document.getElementsByClassName("answer")
const icon = document.getElementsByClassName("QIcon")
question.forEach((question, index)=>{
    question.addEventListener("click", ()=>{
        const state = answer[index].getAttribute("style")
        if(state == "display: block;"){
            answer[index].setAttribute("style", "display: none;")
            icon[index].setAttribute("src", "https://raw.githubusercontent.com/hexschool/2022-web-layout-training/main/2023web-camp/icons/add.png")
        }
        else{
            answer[index].setAttribute("style", "display: block;")
            icon[index].setAttribute("src", "https://github.com/hexschool/2022-web-layout-training/blob/main/2023web-camp/icons/remove.png?raw=true")
        }
    })
})
